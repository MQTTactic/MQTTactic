...
/// See [LLVM 12 docs on Module Structure](https://releases.llvm.org/13.0.0/docs/LangRef.html#module-structure)
#[derive(Clone)]
pub struct Module {
    /// The name of the module
    pub name: String,
    /// See [LLVM 12 docs on Source Filename](https://releases.llvm.org/13.0.0/docs/LangRef.html#source-filename)
    pub source_file_name: String,
    /// See [LLVM 12 docs on Data Layout](https://releases.llvm.org/13.0.0/docs/LangRef.html#data-layout)
    pub data_layout: DataLayout,
    /// See [LLVM 12 docs on Target Triple](https://releases.llvm.org/13.0.0/docs/LangRef.html#target-triple)
    ...
    /// See [LLVM 12 docs on Global Variables](https://releases.llvm.org/13.0.0/docs/LangRef.html#global-variables)
    pub global_vars: Vec<GlobalVariable>,
    /// See [LLVM 12 docs on Global Aliases](https://releases.llvm.org/13.0.0/docs/LangRef.html#aliases)
    pub global_aliases: Vec<GlobalAlias>,
    // --TODO not yet implemented-- pub function_attribute_groups: Vec<FunctionAttributeGroup>,
    /// See [LLVM 12 docs on Module-Level Inline Assembly](https://releases.llvm.org/13.0.0/docs/LangRef.html#moduleasm)
...
/// See [LLVM 12 docs on Linkage Types](https://releases.llvm.org/13.0.0/docs/LangRef.html#linkage)
#[derive(PartialEq, Eq, Clone, Copy, Debug)]
pub enum Linkage {
    Private,
    Internal,
...
/// See [LLVM 12 docs on Visibility Styles](https://releases.llvm.org/13.0.0/docs/LangRef.html#visibility-styles)
#[derive(PartialEq, Eq, Clone, Copy, Debug)]
pub enum Visibility {
    Default,
    Hidden,
...
/// See [LLVM 12 docs on DLL Storage Classes](https://releases.llvm.org/13.0.0/docs/LangRef.html#dllstorageclass)
#[derive(PartialEq, Eq, Clone, Copy, Debug)]
...
/// See [LLVM 12 docs on Thread Local Storage Models](https://releases.llvm.org/13.0.0/docs/LangRef.html#thread-local-storage-models)
#[derive(PartialEq, Eq, Clone, Copy, Debug)]
...
/// For discussion of address spaces, see [LLVM 12 docs on Pointer Type](https://releases.llvm.org/13.0.0/docs/LangRef.html#pointer-type)
pub type AddrSpace = u32;

/// See [LLVM 12 docs on Attribute Groups](https://releases.llvm.org/13.0.0/docs/LangRef.html#attribute-groups)
...
/// See [LLVM 12 docs on Named Metadata](https://releases.llvm.org/13.0.0/docs/LangRef.html#named-metadata)
#[derive(PartialEq, Eq, Clone, Debug)]
...
/// See [LLVM 12 docs on Comdats](https://releases.llvm.org/13.0.0/docs/LangRef.html#langref-comdats)
#[derive(PartialEq, Eq, Clone, Debug)]
pub struct Comdat {
    pub name: String,
