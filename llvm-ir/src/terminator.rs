...
/// See [LLVM 12 docs on Terminator Instructions](https://releases.llvm.org/13.0.0/docs/LangRef.html#terminator-instructions)
...
/// See [LLVM 12 docs on the 'ret' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#ret-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Ret {
...
/// See [LLVM 12 docs on the 'br' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#br-instruction).
...
/// See [LLVM 12 docs on the 'switch' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#switch-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Switch {
    pub operand: Operand,
...
/// See [LLVM 12 docs on the 'indirectbr' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#indirectbr-instruction)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 12 docs on the 'invoke' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#invoke-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Invoke {
...
/// See [LLVM 12 docs on the 'resume' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#resume-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct Resume {
    pub operand: Operand,
    #[cfg(feature = "llvm-9-or-greater")]
...
/// See [LLVM 12 docs on the 'unreachable' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#unreachable-instruction)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 12 docs on the 'cleanupret' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#cleanupret-instruction)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 12 docs on the 'catchret' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#catchret-instruction)
#[derive(PartialEq, Clone, Debug)]
pub struct CatchRet {
...
/// See [LLVM 12 docs on the 'catchswitch' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#catchswitch-instruction)
#[derive(PartialEq, Clone, Debug)]
...
/// See [LLVM 12 docs on the 'callbr' instruction](https://releases.llvm.org/13.0.0/docs/LangRef.html#callbr-instruction)
#[cfg(feature = "llvm-9-or-greater")]
#[derive(PartialEq, Clone, Debug)]
pub struct CallBr {
    pub function: Either<InlineAssembly, Operand>,
...
impl Invoke {
    pub(crate) fn from_llvm_ref(
        ...
        Self {
            ...
            result: if unsafe {
                LLVMGetTypeKind(LLVMGetReturnType(LLVMGetCalledFunctionType(term)))
                    == LLVMVoidTypeKind
            } {
                Name::from("%testxxx")
            } else {
                Name::name_or_num(unsafe { get_value_name(term) }, &mut func_ctx.ctr)
            },
